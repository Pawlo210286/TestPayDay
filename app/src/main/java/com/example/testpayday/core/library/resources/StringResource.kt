...
fun Fragment.getString(stringResource: StringResource): String = stringResource.toString(requireContext())

fun Fragment.getStringOrNull(stringResource: StringResource?): String? = context?.let { stringResource?.toString(it) }
